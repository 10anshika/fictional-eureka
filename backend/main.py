"""
d2c-meets-fintech-reconciliation/backend/main.py
...
async def lifespan(app: FastAPI):
    logger.info(f"D2C meets fintech reconciliation backend starting — env={settings.APP_ENV}")
    yield
    logger.info("D2C meets fintech reconciliation backend shutting down")


app = FastAPI(
    title="D2C meets fintech reconciliation API",
...
app.add_middleware(
    ...
    allow_origin_regex=r"https://d2c-meets-fintech-reconciliation.*\.vercel\.app",
    allow_credentials=True,
    allow_methods=["GET", "POST", "PUT", "DELETE", "PATCH"],
    allow_headers=["*"],
)

# Mount AI classifier (internal tool, no auth required for demo)
...
async def list_transactions(
    ...
    query = (
        ...
        .select(
            ...
            "ai_classification, ai_confidence, ai_explanation, ai_suggested_action, ai_processed_at, "
